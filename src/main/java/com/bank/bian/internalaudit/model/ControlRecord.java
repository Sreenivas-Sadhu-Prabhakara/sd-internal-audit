package com.bank.bian.internalaudit.model;
...
/**
 * The BIAN control record for this service domain: "Audit Engagement Assessment".
 *
 ...
 * to its asset type (Audit Engagement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Audit Engagement Assessment";
